...
export default function AuthorBio({ locale = "el" }: { locale?: string }) {
  ...
  return (
    <aside className="my-12 rounded-2xl border border-gray-200 dark:border-white/10 bg-gradient-to-br from-white to-gray-50 dark:from-[#111827] dark:to-[#0B0F1A] p-6 sm:p-8">
