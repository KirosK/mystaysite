...
export default function FeaturedPost({
  ...
  return (
    <Link
      ...
      className="group block rounded-2xl overflow-hidden bg-white ring-1 ring-gray-100 hover:ring-gray-200 shadow-sm hover:shadow-xl transition-all duration-300 mb-12"
    >
      <div className="grid md:grid-cols-2">
        <div className="relative aspect-[16/10] md:aspect-auto md:min-h-[360px] overflow-hidden bg-gray-100">
          ...
          <span className="absolute top-4 left-4 inline-flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-wider px-3 py-1.5 rounded-full bg-white/95 text-[#1a1a2e] shadow-sm">
            <svg
        ...
        <div className="p-6 sm:p-8 md:p-10 flex flex-col justify-center">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold text-[#1a1a2e] leading-tight mb-3 group-hover:text-[#f57c51] transition-colors">
            {frontmatter.title}
          </h2>
          <p className="text-gray-600 text-base md:text-[0.95rem] leading-relaxed mb-5 line-clamp-3">
            {frontmatter.excerpt}
          </p>
