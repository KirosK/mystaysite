...
const SLIDES: Slide[] = [
  ...
  {
    src: "/portfolio/lunarossa/after-01-hero.png",
    alt: "Luna Rossa Santorini — Direct booking website για studios & apartments στο Ημεροβίγλι",
    domain: "santorini-lunarossa.gr",
    url: "https://www.santorini-lunarossa.gr/en",
    location: { el: "Ημεροβίγλι, Σαντορίνη", en: "Imerovigli, Santorini" },
