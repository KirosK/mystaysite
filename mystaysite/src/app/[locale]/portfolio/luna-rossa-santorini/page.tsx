...
const BEFORE_SRC = [
  "/portfolio/lunarossa/before-01-hero.png",
  "/portfolio/lunarossa/before-02-about.png",
  "/portfolio/lunarossa/before-03-rooms.png",
  "/portfolio/lunarossa/before-04-contact.png",
];

const AFTER_SRC = [
  "/portfolio/lunarossa/after-01-hero.png",
  "/portfolio/lunarossa/after-02-about.png",
  "/portfolio/lunarossa/after-03-rooms.png",
  "/portfolio/lunarossa/after-04-reviews.png",
  "/portfolio/lunarossa/after-05-location.png",
  "/portfolio/lunarossa/after-06-arrange.png",
  "/portfolio/lunarossa/after-07-contact.png",
  "/portfolio/lunarossa/after-08-faq.png",
];

const BEFORE_LABELS_EL = ["Hero", "About", "Room types", "Contact"];
const BEFORE_LABELS_EN = ["Hero", "About", "Room types", "Contact"];
const AFTER_LABELS_EL = ["Hero", "About", "Rooms", "Reviews", "Location", "Services", "Booking", "FAQ"];
const AFTER_LABELS_EN = ["Hero", "About", "Rooms", "Reviews", "Location", "Services", "Booking", "FAQ"];
    ...
    <div>
      ...
      >
        <div className={`transition-opacity duration-150 ${fading ? "opacity-0" : "opacity-100"}`}>
          <Image src={current.src} alt={`Luna Rossa Santorini ${label.toLowerCase()}: ${current.label}`} width={1440} height={900}
...
export default function LunaRossaCaseStudy({
  params,
}: {
  ...
  const copy = isEn
    ? {
        ...
        subtitle:
          "From a dated hotel website to a premium direct-booking experience with bilingual content, room pages, reviews, local guide sections, and stronger trust signals.",
        beforeAfterTitle: "Before & After",
        beforeAfterText: "4 key screenshots from the old site and 8 from the new experience. Tap the arrows or swipe.",
        beforeLabel: "BEFORE",
        afterLabel: "AFTER",
    ...
    : {
        ...
        subtitle:
          "Από ένα παλιό website ξενοδοχείου σε premium direct-booking εμπειρία με δύο γλώσσες, room pages, reviews, local guide sections και πιο δυνατά trust signals.",
        beforeAfterTitle: "Πριν & Μετά",
        beforeAfterText: "4 βασικά screenshots από το παλιό site και 8 από τη νέα εμπειρία. Κάνε κλικ στα βελάκια ή swipe.",
        beforeLabel: "ΠΡΙΝ",
        afterLabel: "ΜΕΤΑ",
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-16">
        ...
        <div className="bg-white dark:bg-[#111827] rounded-xl border border-gray-100 dark:border-white/10 p-6 mb-16 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm dark:shadow-black/30">
          <div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">santorini-lunarossa.gr</p>
          </div>
          <a
            href="https://www.santorini-lunarossa.gr/en"
            target="_blank"
            rel="noopener noreferrer"
            onClick={() =>
              trackOutboundClick(
                "https://www.santorini-lunarossa.gr/en",
                "luna_rossa_case_study"
              )
            }
        ...
        <div className="bg-[#0F172A] rounded-2xl p-8 md:p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              onClick={() => trackWhatsApp("luna_rossa_case_study")}
