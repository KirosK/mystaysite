  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          Websites για ενοικιαζόμενα δωμάτια στην Ελλάδα
        </div>
        ...
        >
          ...
          >
            <span style={{ fontSize: 18, color: "#60A5FA", fontWeight: 600 }}>Apo €349</span>
          </div>
          <div
            style={{
              background: "rgba(59,130,246,0.1)",
          ...
          >
            <span style={{ fontSize: 18, color: "#60A5FA", fontWeight: 600 }}>Dorean Mockup 48h</span>
          </div>
        </div>
      </div>
    ),
