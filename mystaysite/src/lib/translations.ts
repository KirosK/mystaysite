...
export const translations = {
  gr: {
    ...
    hero: {
      ...
      ctaSecondary: "Δες τις δουλειές μας",
    },
    trust: {
    ...
    pricing: {
      ...
      professional: {
        ...
        cta: "Θέλω κρατήσεις χωρίς προμήθεια",
      ...
      premium: {
        ...
        features: [
          ...
          "Google Ads - setup 1ης καμπάνιας + €50 ad credit",
      ...
      items: [
        {
          ...
          text: "Σου στέλνουμε δωρεάν mockup ΠΡΙΝ πληρώσεις. Δεν σου αρέσει; Δεν χρωστάς ούτε ευρώ. Φεύγεις χωρίς υποχρεώσεις.",
        },
        {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "2-5 εργάσιμες ημέρες μετά την έγκριση του mockup. Τα απλούστερα sites μπορεί να είναι έτοιμα σε 2 ημέρες.",
        },
        {
          q: "Χρειάζομαι domain;",
        ...
        },
        {
          ...
          a: "Ναι, αν θέλεις. Αλλά οι περισσότεροι πελάτες μας μας στέλνουν τι θέλουν να αλλάξει και το κάνουμε εμείς. Αυτό καλύπτεται από τη μηνιαία συντήρηση (€29/μήνα) ή χρεώνεται ανά αλλαγή.",
        },
        {
    ...
    contact: {
      ...
      subtitle: "Στείλε μας το Booking ή Airbnb link σου. Σε 48 ώρες βλέπεις πώς θα μοιάζει το site σου.",
      ...
      success: "Ευχαριστούμε! Θα δεις mockup στο email σου μέσα σε 48 ώρες.",
    ...
    footer: {
      ...
      copyright:
        "© 2026 MyStaySite.gr - Φτιάχνουμε websites που φέρνουν κρατήσεις.",
    },
    whatsapp: {
    ...
    mobileCta: {
      whatsapp: "WhatsApp",
      sendLink: "Στείλε Link",
    },
    chatbot: {
      title: "MyStaySite",
      subtitle: "Απαντάμε σε < 1 λεπτό",
      greeting: "Γεια σου! Είμαι η Μαρία από την MyStaySite. Φτιάχνουμε websites για ενοικιαζόμενα δωμάτια. Πώς μπορώ να σε βοηθήσω;",
      options: [
        "Θέλω δωρεάν mockup",
        "Πόσο κοστίζει;",
        "Πώς λειτουργεί;",
      ],
      askLink: "Τέλεια! Στείλε μου το Booking ή Airbnb link του καταλύματός σου και σου ετοιμάζουμε δωρεάν mockup σε 48 ώρες.",
      askContact: "Ωραία! Τώρα χρειάζομαι το email ή το τηλέφωνό σου για να σου στείλουμε το mockup.",
      pricingReply: "Τα πακέτα μας ξεκινούν από €349 για βασικό website. Το πιο δημοφιλές είναι το Professional στα €599 με σύστημα κρατήσεων, reviews, 2 γλώσσες και Google Analytics. Θέλεις να σου ετοιμάσουμε δωρεάν mockup;",
      ...
      yesOption: "Ναι, θέλω mockup!",
      thanksTitle: "Ευχαριστούμε!",
      thanks: "Τέλεια! Θα δεις mockup στο email σου μέσα σε 48 ώρες. Αν έχεις κάποια ερώτηση, στείλε μας στο WhatsApp!",
  ...
  en: {
    ...
    pricing: {
      ...
      professional: {
        ...
        cta: "Get bookings with zero commission",
      ...
      premium: {
        ...
        features: [
          ...
          "Google Ads - 1st campaign setup + €50 ad credit",
      ...
      maintenance:
        "Optional: Monthly maintenance - €29/month (photo changes, pricing, seasonal content)",
      guarantee:
      ...
      items: [
        {
          ...
          text: "We send you a free mockup BEFORE you pay. Don't like it? You don't owe a single euro. Walk away with zero obligations.",
        },
        {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "2-5 business days after mockup approval. Simpler sites can be ready in 2 days.",
        },
        {
        ...
        },
        {
          ...
          a: "Yes, if you want. But most of our clients send us what they want changed and we do it. This is covered by monthly maintenance (€29/month) or charged per change.",
        },
        {
    ...
    contact: {
      ...
      subtitle: "Send us your Booking or Airbnb link. In 48 hours you'll see what your site will look like.",
      ...
      success: "Thank you! You'll see a mockup in your email within 48 hours.",
    ...
    footer: {
      ...
      copyright:
        "© 2026 MyStaySite.gr - We build websites that bring bookings.",
    },
    whatsapp: {
    ...
    chatbot: {
      ...
      greeting: "Hi! I'm Maria from MyStaySite. We build websites for vacation rentals. How can I help you?",
      options: [
        "I want a free mockup",
        "How much does it cost?",
        "How does it work?",
      ],
      askLink: "Great! Send me your Booking or Airbnb link and we'll prepare a free mockup in 48 hours.",
      askContact: "Perfect! Now I need your email or phone number so we can send you the mockup.",
      pricingReply: "Our packages start at €349 for a basic website. The most popular is Professional at €599 with booking system, reviews, 2 languages and Google Analytics. Would you like a free mockup?",
      ...
      yesOption: "Yes, I want a mockup!",
      thanksTitle: "Thank you!",
      thanks: "Perfect! You'll see a mockup in your email within 48 hours. If you have any questions, message us on WhatsApp!",
